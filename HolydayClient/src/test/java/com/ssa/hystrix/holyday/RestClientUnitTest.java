...
public class RestClientUnitTest{
    ...
    public void testSynchronousUptoVolumeThreshold() throws Exception{
    	...
    	int i =0;
    	  Observable<String> fWorld1 = new CommandHelloWorld("World1", 2*1000, ++i).observe();
    	  Observable<String> fWorld2 = new CommandHelloWorld("World2", 2*1000, 1).observe();    	  
    	  Observable<String> fWorld3 = new CommandHelloWorld("World3", 5*1000, ++i).observe();
    	  Observable<String> fWorld4 = new CommandHelloWorld("World4", 2*1000, ++i).observe();
    	  Observable<String> fWorld5 = new CommandHelloWorld("World5", 2*1000, ++i).observe();
    	  Observable<String> fWorld6 = new CommandHelloWorld("World6", 2*1000, ++i).observe();
    	  Observable<String> fWorld7 = new CommandHelloWorld("World7", 2*1000, ++i).observe();
    	  Observable<String> fWorld8 = new CommandHelloWorld("World8", 2*1000, ++i).observe();
    	  Observable<String> fWorld9 = new CommandHelloWorld("World9", 2*1000, ++i).observe();
    	  Observable<String> fWorld10 = new CommandHelloWorld("World10", 2*1000, ++i).observe();
