...
public class HolydayRest_1 extends HystrixCommand<String>{

	private static String hystrixCommandGroupKey = "ExampleGroup";
	
	private static String name = "sample";
	private static int delaySec = 10;
	private static HolydayRest_1 holydayRest;
	private String url;
	private static HolydayConfig config;
	
	public static HolydayRest_1 getInstance() {
		holydayRest = new HolydayRest_1(name);
        return holydayRest;
    }
	
	public static HolydayRest_1 getInstance(HolydayConfig configParam) {
		config = configParam;
	...
	protected HolydayRest_1(String name) {
	...
	public static void setDelaySec(int delaySec) {
		HolydayRest_1.delaySec = delaySec;
	}
