...
public class CommandHelloWorld_1 extends HystrixCommand<String>{
...
//        super(HystrixCommandGroupKey.Factory.asKey("ExampleGroup"));
    ...
    protected String run() {
		...
		String addr = "http://localhost:8080/api/timeline/1";
		...
		//http://192.168.0.19:8080/api/timeline/
				System.out.println("Client 1 Sec: " + jsonResponse.getBody());
