...
import com.ssa.hystrix.holyday.HolydayRest;

public abstract class CommandHolydayEdited extends HystrixCommand<String>{
	...
	public CommandHolydayEdited(String url, GetRequest request) {
